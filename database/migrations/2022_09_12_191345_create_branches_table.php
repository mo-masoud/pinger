...
class CreateBranchesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('branches', function (Blueprint $table) {
            ...
            $table->string("financial_code")->unique()->index();
            ...
            $table->foreignId('branch_level_id')->constrained()->cascadeOnDelete();
            $table->json('working_days')->nullable();
            $table->string('start_time')->nullable();
            $table->string('end_time')->nullable();
            $table->string('modeling')->nullable();
            $table->string('ups_installation')->nullable();
            $table->foreignId('line_type_id')->constrained()->cascadeOnDelete();
